# This script trains the LoRA model with personalized data
...
# ✅ 1. 设置模型和 LoRA 参数
model_id = "facebook/opt-125m"  # 使用 OPT-2.7B 替代 Flan-T5
...
training_args = TrainingArguments(
    output_dir="./opt-2.7b-lora-output",
...
model = PeftModel.from_pretrained(base_model, "./opt-2.7b-lora-output")
